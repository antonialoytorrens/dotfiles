...
#Desktop-Session Library Files
lib_desktop_session="$lib_dir/lib-desktop-session.sh"
lib_logging="$lib_dir/lib-logging-ds"
lib_popup="$lib_dir/lib-popup-window.sh"
lib_xdg_dirs="$lib_dir/desktop-session-xdg-dirs.sh"

#Log File
log_file="$user_dts_dir/current.log";
...
#Desktop-session shutdown scripts
main_shutdown_file="$main_dts_dir/shutdown";
user_shutdown_file="$user_dts_dir/shutdown";
...
#Icon/Session binary path
rox_path="/usr/bin/rox-filer"
space_path="/usr/bin/spacefm"
zzz_path="/usr/bin/zzzfm"
icewm_path="/usr/bin/icewm"
jwm_path="/usr/bin/jwm"
fluxbox_path="/usr/bin/fluxbox"

#Xsessions
xs_dir="/usr/share/xsessions";
#Waylandsessions
ws_dir="/usr/share/wayland-sessions";

#Login Manager Config
slim_conf="/etc/slim.conf";
slimski_conf="/etc/slimski.local.conf";
slimski_lastused="$HOME/.config/slimski.lastused";
[ ! -f "$slimski_conf" ] && [ -f "/etc/slimski.conf" ] && slimski_conf="/etc/slimski.conf";
